...
/**
 * This class is for the Connection for PostgreSQL here and of course for getting the
 * Data for the Synchronising with MySQL
 * 
 ...
 * @param rm
 */
	public PostgreSQLcon(String url, String dbname, String uname, String pwd,
			RunMiddleware rm) {
	...
	public void connect() throws ClassNotFoundException, SQLException {
		System.out.println("PostgreSQL Treiber is loading ...");

		Class.forName(JDBC_DRIVER);

		System.out.println("PostgreSQL is connecting......");
	...
	public ArrayList<String> getTables() throws SQLException {
		resultSet = statement
				.executeQuery("SELECT * FROM information_schema.tables WHERE table_schema = 'public';");
		while (resultSet.next()) {
			tabeles.add(resultSet.getString(3));
		}
		return tabeles;
	}

	public void run() {
		System.out.println("PostgreSQL started the checking!");
